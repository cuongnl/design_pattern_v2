...
import model.impl.DefaultPropertyArgDefinition;
import support.annotation.Lazys;
import support.annotation.Scopes;
import support.condition.Condition;
import support.condition.impl.DefaultConditionContext;
import support.envrionment.ConfigurableEnvironment;
import support.envrionment.Environment;
import support.envrionment.PropertyResolver;
import support.envrionment.PropertySource;
import support.envrionment.impl.DefaultEnvironment;
import support.envrionment.impl.PropertiesPropertySource;
import support.envrionment.impl.PropertySourcesPropertyResolver;
import support.name.BeanNameStrategy;
import support.name.impl.DefaultBeanNameStrategy;
import support.scanner.AnnotationBeanDefinitionScanner;
import support.scanner.BeanDefinitionScannerContext;
import support.scanner.impl.ClassPathAnnotationBeanDefinitionScanner;
import support.scanner.impl.DefaultBeanDefinitionScannerContext;
...
public class AnnotationApplicationContext extends AbstractApplicationContext {
     ...
     * （2）结合 {@link support.envrionment.impl.PropertySourcesPropertyResolver} 处理
     * {@link Value} 注解标注的信息。
     * （3）类似于自动注入，处理相关的信息。
     ...
     * （2）这里需要递归处理，处理 class 头上的 {@link annotation.Import} 配置信息。
     *
     * @return 配置类列表
     * @since 0.1.4
     */
    ...
    /**
     * 构建 {@link annotation.Bean} 注解指定的方法对应的信息
     *
